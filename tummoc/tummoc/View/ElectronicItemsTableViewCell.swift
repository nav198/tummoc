//
//  ElectronicItemsTableViewCell.swift
//  tummoc
//
...
class ElectronicItemsTableViewCell: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        let ElectronicItems = shoppingCartData.filter({$0.name == "Electronic Items"}).first?.items?.count ?? 0
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        guard let itemsValue = shoppingCartData.filter({ $0.name == "Electronic Items" }).first?.items else { return cell }
    ...
    func addingToCartAction(at indexPath: IndexPath) {
        guard var category = shoppingCartData.first(where: { $0.name == "Electronic Items" }),
    ...
    func addToFavouritesAction(at indexPath: IndexPath) {
        ...
        do {
            ...
            shoppingCartData.removeAll(where: { $0.name == "Electronic Items" })
